...
let tabletFirstWordHandled = false; // tablet only
...
let selectedUnit = 'unit2'; // 기본값: Unit 1
...
function loadWords() {
  ...
  const file = isLocal ? './data/unit2.json?v=1.0' : '/game/unit2/data/unit2.json?v=1.0';
